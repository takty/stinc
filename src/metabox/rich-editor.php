	...
	add_meta_box(
		...
		function ( $post ) use ( $key, $sub_key_title, $sub_key_content ) {
			...
			<div class="stinc-field-title">
				<input
					type="text" size="30" spellcheck="true" autocomplete="off" placeholder="<?php echo esc_attr( $title_placeholder ); ?>"
					name="<?php echo esc_attr( $sub_key_title ); ?>" id="<?php echo esc_attr( $sub_key_title ); ?>"
