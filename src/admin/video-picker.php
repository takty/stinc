...
function enqueue_script_for_admin( $url_to ) {
	wp_enqueue_script( 'st-video-picker', $url_to.'/asset/video-picker.min.js', [ 'jquery-ui-sortable' ] );
	wp_enqueue_style( 'st-video-picker', $url_to.'/asset/video-picker.min.css' );
}
