...
namespace st {
	...
	if ( ! function_exists( '\st\get_request_url' ) ) {
		/**
		 * Gets request URL.
		 *
	...
	if ( ! function_exists( '\st\serialize_url' ) ) {
		/**
